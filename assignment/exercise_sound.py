...
#based on https://www.coderdojotc.org/micropython/sound/05-play-mario/
random_notes = [
    "D5", "D5", "D5", "P", "B4", "D5", "E5", "E5", "E5", "P", "B4", "D5", "E5", "E5", "D5",
    "C5", "A4", "C5", "B4", "P", "G4", "A4", "A4", "G4", "F4", "D4", "E4", "P", "D4", "E4", "F4", 
    "P", "G4", "A4", "B4", "P", "D5", "E5", "E5", "P", "B4", "D5", "E5", "E5", "D5", "C5", "A4", 
    "P", "C5", "B4", "P", "G4", "A4", "A4", "G4", "F4", "D4", "E4", "P", "D4", "E4", "F4", "P"
]
